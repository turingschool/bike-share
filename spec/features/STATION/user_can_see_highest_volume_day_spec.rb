RSpec.describe "When user goes to the station id page, user can see" do
  it "highest volume date" do
    ...
    Trip.create(duration: 80000, start_date: "1969/6/20", end_date: "1969/7/20", start_station_id: 2, end_station_id: 1, bike_id: 777, subscription_type: "subscriber")


    visit '/stations/2'
    expect(page).to have_content(station_b.highest_volume_date_here)
  end
end
