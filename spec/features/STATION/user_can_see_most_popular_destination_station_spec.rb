RSpec.describe "When user goes to the station id page, user can see" do
  it "most popular destination station" do
    ...
    Trip.create(duration: 60000, start_date: "1969/5/20", end_date: "1969/4/20", start_station_id: 2, end_station_id: 3, bike_id: 666, subscription_type: "customer")
    Trip.create(duration: 80000, start_date: "1969/5/20", end_date: "1969/7/20", start_station_id: 3, end_station_id: 1, bike_id: 777, subscription_type: "subscriber")


    visit '/stations/1'
    expect(page).to have_content(station.highest_volume_date_here)
  end
end
