RSpec.describe "When user goes to the station id page, user can see" do
  it "most frequent destination station" do
    ...
    Trip.create(duration: 80000, start_date: "1969/5/20", end_date: "1969/7/20", start_station_id: 1, end_station_id: 2, bike_id: 777, subscription_type: "subscriber")


    visit '/stations/1'
    expect(page).to have_content(station_a.most_frequent_destination_station)
  end
end
