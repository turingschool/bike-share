RSpec.describe "When user goes to the station analytics page, user can see" do
  it "most popular ending station" do
    ...
    Trip.create(duration: 60000, start_date: "1969/5/20", end_date: "1969/6/20", start_station_id: 2, end_station_id: 1å, bike_id: 666, subscription_type: "customer")
