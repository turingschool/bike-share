RSpec.describe "When user goes to the station id page, user can see" do
  it "most popular origination station" do
    ...
    station_c = Station.create(name: "SanFranSokyoeki", city: "Tokyo", installation_date: "1987/6/20", dock_count: 82)
  	Trip.create(duration: 40000, start_date: "1969/4/20", end_date: "1969/4/20", start_station_id: 1, end_station_id: 3, bike_id: 666, subscription_type: "customer")
    ...
    Trip.create(duration: 80000, start_date: "1969/6/20", end_date: "1969/7/20", start_station_id: 2, end_station_id: 3, bike_id: 777, subscription_type: "subscriber")


    visit '/stations/3'
    expect(page).to have_content(station_c.most_frequent_origination_station)
  end
end
