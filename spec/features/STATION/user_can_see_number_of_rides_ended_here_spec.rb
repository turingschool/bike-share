RSpec.describe "When user goes to the station id page, user can see" do
  it "number of rides ended here" do
    ...
    Trip.create(duration: 60000, start_date: "1969/5/20", end_date: "1969/6/20", start_station_id: 2, end_station_id: 1, bike_id: 666, subscription_type: "customer")
    ...
    visit '/stations/1'
    expect(page).to have_content(station_a.number_of_rides_ended_here)
  end
end
