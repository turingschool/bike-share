RSpec.describe "When user goes to the station analytics page, user can see" do
  it "station with maximum dock count" do
    ...
    expect(page).to have_content(Station.maximum_dock_count)
    expect(page).to have_content(Station.station_with_maximum_dock_count.first.name)
  end
end
