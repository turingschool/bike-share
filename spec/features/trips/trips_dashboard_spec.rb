...
<<<<<<< HEAD
  ...
  Trip.create(duration: 1200, start_date: "2017-08-20 19:20:22", start_station_id: start_station.id, end_date: "2017-08-20 19:20:22", end_station_id: start_station.id, bike_id: 4, subscription_type: SubscriptionType.create(subscription_type: "Customer"), zip_code: 99000)

  Trip.create(duration: 600, start_date: "2017-08-05 19:20:22", start_station_id: start_station.id, end_date: "2017-08-05 19:20:22", end_station_id: start_station.id, bike_id: 520, subscription_type: SubscriptionType.create(subscription_type: "Subscription"), zip_code: 12345)
