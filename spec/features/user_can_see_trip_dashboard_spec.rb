...
#
#       within("body") do
#           expect(page).to have_content('Station with the most rides as a starting place: Denver Station (2)')
#       end
#
#       within("body") do
#           expect(page).to have_content('Station with the most rides as an ending place: "New York Station" (2)')
#       end
#
#       within("body") do
