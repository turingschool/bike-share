...
RSpec.describe "User visits '/trips'" do
  it "sees information on 30 trips per page" do
    ...
    Trip.create(duration: 49, start_date: "2017-08-20 19:20:22",  start_station_name: "Banana Town", start_station_id: 84, end_date: "2017-08-20 19:20:22", end_station_name: "Pants Town", end_station_id: 94, bike_id: 999, subscription_type: "Customer", zip_code: 99000)
    Trip.create(duration: 49, start_date: "2017-08-20 19:20:22",  start_station_name: "Banana Town", start_station_id: 84, end_date: "2017-08-20 19:20:22", end_station_name: "Pants Town", end_station_id: 94, bike_id: 847, subscription_type: "Customer", zip_code: 99000)
    ...
    expect(page).to have_content("99000")
    expect(page).to have_content("Subscriber")
