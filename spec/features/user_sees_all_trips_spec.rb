...
RSpec.describe "A user can view trip" do
  it "and has all content" do
    Trip.create(duration: 63, start_date: "2013/8/28", start_station_name: "South Van Ness at Market", end_date: "2013/08/29", end_station_name: "South Van Ness at Market", bike_id: 520, subscription_type: "Subscriber", zip_code: 94127)
    visit '/trips'
