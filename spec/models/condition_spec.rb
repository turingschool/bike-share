RSpec.describe Condition do
  ...
  describe ".sort_precip_min" do
    it 'finds the min amount of trips for a given precipitation range' do
      start_date = DateTime.new(2001,2,3,4,5,6)
      t_1 = Trip.create(duration: 10, start_date: start_date, start_station_id: 1, end_date: start_date, end_station_id: 2, bike_id: 1, subscription_type: "Type", zip_code: 12345)
      t_2 = Trip.create(duration: 20, start_date: start_date, start_station_id: 2, end_date: start_date, end_station_id:3, bike_id: 2, subscription_type: "Type", zip_code: 12345)
      c_1 = Condition.create(date: start_date, max_temperature: 45, mean_temperature: 50, min_temperature: 20, mean_humidity: 3, mean_visibility: 3, mean_wind_speed: 20, precipitation: 1, trip_id: t_1.id)
      ...
      expect(Condition.sort_precip_min(0.5..1)).to eq(1)
    end
  end

  describe ".sort_precip_mean" do
    it 'finds the average amount of trips for a given precipitation range' do
      start_date = DateTime.new(2001,2,3,4,5,6)
      t_1 = Trip.create(duration: 10, start_date: start_date, start_station_id: 1, end_date: start_date, end_station_id: 2, bike_id: 1, subscription_type: "Type", zip_code: 12345)
      t_2 = Trip.create(duration: 20, start_date: start_date, start_station_id: 2, end_date: start_date, end_station_id:3, bike_id: 2, subscription_type: "Type", zip_code: 12345)
      c_1 = Condition.create(date: start_date, max_temperature: 45, mean_temperature: 50, min_temperature: 20, mean_humidity: 3, mean_visibility: 3, mean_wind_speed: 20, precipitation: 1, trip_id: t_1.id)
      ...
      expect(Condition.sort_precip_mean(1..2)).to eq(1)
    end
  end

  describe ".sort_sight_max" do
    it 'finds the max amount of trips for a given visibility range' do
      start_date = DateTime.new(2001,2,3,4,5,6)
      t_1 = Trip.create(duration: 10, start_date: start_date, start_station_id: 1, end_date: start_date, end_station_id: 2, bike_id: 1, subscription_type: "Type", zip_code: 12345)
      t_2 = Trip.create(duration: 20, start_date: start_date, start_station_id: 2, end_date: start_date, end_station_id:3, bike_id: 2, subscription_type: "Type", zip_code: 12345)
      c_1 = Condition.create(date: start_date, max_temperature: 45, mean_temperature: 50, min_temperature: 20, mean_humidity: 3, mean_visibility: 3, mean_wind_speed: 20, precipitation: 1, trip_id: t_1.id)
      ...
      expect(Condition.sort_sight_max(0..5)).to eq(2)
    end
  end

  describe ".sort_sight_min" do
    it 'finds the max amount of trips for a given visibility range' do
      start_date = DateTime.new(2001,2,3,4,5,6)
      t_1 = Trip.create(duration: 10, start_date: start_date, start_station_id: 1, end_date: start_date, end_station_id: 2, bike_id: 1, subscription_type: "Type", zip_code: 12345)
      t_2 = Trip.create(duration: 20, start_date: start_date, start_station_id: 2, end_date: start_date, end_station_id:3, bike_id: 2, subscription_type: "Type", zip_code: 12345)
      ...
      expect(Condition.sort_sight_min(0..5)).to eq(2)
    end
  end

  describe ".sort_sight_mean" do
    it 'finds the max amount of trips for a given visibility range' do
      start_date = DateTime.new(2001,2,3,4,5,6)
      t_1 = Trip.create(duration: 10, start_date: start_date, start_station_id: 1, end_date: start_date, end_station_id: 2, bike_id: 1, subscription_type: "Type", zip_code: 12345)
      t_2 = Trip.create(duration: 20, start_date: start_date, start_station_id: 2, end_date: start_date, end_station_id:3, bike_id: 2, subscription_type: "Type", zip_code: 12345)
      ...
      expect(Condition.sort_sight_mean(0..5)).to eq(1)
    end
  end
end
