...
RSpec.describe StartDate do
  describe "attributes" do
    it "can access values in columns" do
      start_date = StartDate.create(ride_date_id: 1)

      expect(start_date.ride_date_id).to eq(1)
    end
  end
  ...
  describe "validations" do
    it "is invalid without a ride date id" do
      ...
      start_date = StartDate.create(ride_date_id: nil)
  ...
  describe "relationships" do
    it "can access ride date attributes" do
      ...
      expect(start_date.ride_date.month).to eq(9)
    end
    ...
    it "can access trip attributes" do
      ...
      expect(start_date.trips.count).to eq(1)
    end
  end
end
