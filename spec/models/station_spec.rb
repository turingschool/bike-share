...
RSpec.describe Station do
  describe "attributes" do
    it "returns value in name column" do
      ...
      station = Station.create(name: "MLK Station", dock_count: 19, city_id: 1, installation_date: "8/6/2013")
  ...
  describe "validations" do
    it "is invalid without a name" do
      city = City.create(name: "San Jose")
      station_1 = Station.create(dock_count: 19, city_id: 1, installation_date: "8/6/2013")
      ...
      it "is invalid without a dock count" do
        city = City.create(name: "San Jose")
        station_1 = Station.create(name: "MLK Station",city_id: 1, installation_date: "8/6/2013")
