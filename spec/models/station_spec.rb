...
RSpec.describe Station do
  ...
  it "can calculate the average number of bikes for all stations" do
    Station.create(name: "something", dock_count: 1, city_id: 1, installation_date: Date.strptime("08/30/2013",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
    ...
    Station.create(name: "other", dock_count: 3, city_id: 1, installation_date: Date.strptime("08/30/2013",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
    Station.create(name: "and again", dock_count: 4, city_id: 1, installation_date: Date.strptime("08/30/2013",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
  ...
  it "can find the oldest station created" do
    Station.create(name: "something", dock_count: 1, city_id: 1, installation_date: Date.strptime("08/20/2014",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
    Station.create(name: "else", dock_count: 2, city_id: 1, installation_date: Date.strptime("07/19/2012",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
    Station.create(name: "other", dock_count: 3, city_id: 1, installation_date: Date.strptime("01/30/2013",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
    Station.create(name: "and again", dock_count: 4, city_id: 1, installation_date: Date.strptime("08/29/2013",'%m/%d/%Y'), longitude: -121.9, latitude: 30.7)
