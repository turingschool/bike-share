...
RSpec.describe Trip do
  ...
  describe 'validations' do
    it 'is valid with a duration, start_date, end_date, subscription_type, bike_id, start_station_id, end_station_id and weather_id' do
      ...
      trip = Trip.create(duration: 22, start_date: DateTime.strptime('8/29/2013 14:01', '%m/%d/%Y %k:%M'), end_date:DateTime.strptime('8/29/2013 14:23', '%m/%d/%Y %k:%M'), subscription_type: 'subscriber', bike_id: 1, start_station_id: 1, end_station_id: 2, weather_id: 1)
